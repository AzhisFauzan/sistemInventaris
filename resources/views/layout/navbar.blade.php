    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item mx-2" style="display: flex; align-items: center;">
            <a class="nav-link py-1" href="#" id="alertsDropdownBtn" style="position: relative; display: flex; align-items: center;">
                ...
                <span class="badge badge-danger" style="position: absolute; top: 0px; right: -2px; font-size: 0.65rem; border-radius: 50%; padding: 3px 5px;">3</span>
            </a>
            ...
            <div id="alertsDropdownMenu" class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                <a class="dropdown-item d-flex align-items-center" href="#" style="padding: 10px 15px; border-bottom: 1px solid #eee; white-space: normal;">
